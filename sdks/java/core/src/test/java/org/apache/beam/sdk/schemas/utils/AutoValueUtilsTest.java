...
public class AutoValueUtilsTest {
  ...
  @AutoValue
  public abstract static class GenericAutoValue<T, N extends Number> {
    public abstract T getT();

    public abstract N getN();

    @AutoValue.Builder
    public abstract static class Builder<T, N extends Number> {
      public abstract Builder<T, N> setT(T value);

      public abstract Builder<T, N> setN(N value);

      public abstract GenericAutoValue<T, N> build();
    }
  }
